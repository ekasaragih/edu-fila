        ...
        <main>
            <div class="container mt-4">
                ...
                <ul class="nav nav-tabs" id="preventTabs">
                    <li class="nav-item">
                        <a class="nav-link active" id="bookletTabLink" data-toggle="tab" href="#bookletTabContent">Booklet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="litfetTabLink" data-toggle="tab" href="#litfetTabContent">Litfet</a>
                    </li>
                </ul>
                ...
                <div class="tab-content mt-3" id="preventTabsContent">
                    ...
                    <!-- Litfet -->
                    <div class="tab-pane fade" id="litfetTabContent">
                        <div class="litfet-container mt-4">
                            <div class="litfet-content">
